...
class SimulationManager:
    ...
    def worker_job(self, sim, gpu_idx, gpu_mem_block=False):
    ...
    def run(self, log=None, join=False, gpu_mem_block=False, custom_observables=None, run_when_failed=False,
            cpu_run=False):
...
class OxdnaAnalysisTools:
    ...
    def angle(self, base_list_file_1=None, base_list_file_2=None, base_list_file_3=None, base_list_1=None, base_list_2=None, base_list_3=None, args='',
                     join=False):
        """
        ...
        def run_angle(self, base_list_file_1, base_list_file_2, base_list_file_3, args=''):
            start_dir = os.getcwd()
            os.chdir(self.sim.sim_dir)
            os.system(f'oat angle -i {self.sim.sim_files.traj} {base_list_file_1} {base_list_file_2} {base_list_file_3} {args}')
            os.chdir(start_dir)
        ...
        p = mp.Process(target=run_angle, args=(self, base_list_file_1, base_list_file_2, base_list_file_3), kwargs={'args': args})
        p.start()
        if join:
            p.join()
            
            
    def determine_cv_sign(self, base_list_file_1=None, base_list_file_2=None, base_list_file_3=None, base_list_1=None, base_list_2=None, base_list_3=None, args='',
                     join=False):
        """
        Find the angle between the center of mass of three groups of particles (currently not supported generally). Use args='-h' for more details
        """
        ...
        def run_angle(self, base_list_file_1, base_list_file_2, base_list_file_3, args=''):
            start_dir = os.getcwd()
            os.chdir(self.sim.sim_dir)
            os.system(f'oat determine_cv_sign -i {self.sim.sim_files.traj} {base_list_file_1} {base_list_file_2} {base_list_file_3} {args}')
            os.chdir(start_dir)
